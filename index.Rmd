...
## “Openscapes has created a new way of thinking about merging empathy and science. That's an invaluable gift to me.” 
...
## "But I don't have time/am not supported"

## "Just the nature of ecological research"
...
normalize, identify & address, think ahead
...
---
## Build shared practices, confidence, skills

<br>


```{r, eval=FALSE, echo=TRUE}
source("julies_script.R")    # all my steps tangled together
```
...
source("common.R")           # just my code for a lookup table
```
...
remotes::install_github("ohicore")    # now our code is easier to install
```
...
## Rmd for iteration and communication
